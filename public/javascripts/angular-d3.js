...
//used to reference sizes in controller
var sizeIndex = 0;
var sizeReturner = function(textSizes, size) {
    sizeIndex = (sizeIndex + 1)%size;
    return textSizes[sizeIndex];
};
      ...
      link: function postLink(scope, element, attrs) {
        ...
        var cloudFactory = function (words) {
          ...
          d3.layout.cloud().size([
            ...
            return {
              text: d,
              //size: Math.random() * fontSize //CHANGE THIS
              size: sizeReturner(sizeWord, numWords)
              // size: words = scope.words;
            };
          })).rotate(function () {
